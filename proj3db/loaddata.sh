...
echo $PATH
OSNAME=`uname -s`
ART_DATA_PATH=/tmp/applifire/db/MS0LIKMP3XOAFJOBG2VPEG/18D01ABF-F632-496A-B379-FC50EDEAB8C0/art/data
AST_DATA_PATH=/tmp/applifire/db/MS0LIKMP3XOAFJOBG2VPEG/18D01ABF-F632-496A-B379-FC50EDEAB8C0/ast/data
MYSQL=/usr/bin
