package com.app.server.service.organizationextendedbc.locationextended.aspect;
...
@Aspect
@Component
public class ServicelocationextendedAspect extends ServiceAspect {
    ...
    public Object aroundAdvice1(ProceedingJoinPoint proceedingJoinPoint) throws Throwable {
        ...
        try {
            ...
            AppAlarm appAlarm = Log.getAlarm("OEBLE154101500");
            ResponseBean exceptionbean = new ResponseBean(appAlarm);
    ...
    public Object aroundAdvice2Save(ProceedingJoinPoint proceedingJoinPoint) throws Throwable {
        ...
        ResponseEntity<ResponseBean> responseEntity = new ResponseEntity<>(HttpStatus.OK);
        try {
            Log.out.println("OEBLE114100100", runtimeLogInfoHelper.getRequestHeaderBean(), proceedingJoinPoint.getSignature().getDeclaringTypeName(), proceedingJoinPoint.getSignature().getName(), proceedingJoinPoint.getSignature().getDeclaringTypeName() + ":" + proceedingJoinPoint.getSignature().getName());
            ...
            Log.out.println("OEBLE124100100", runtimeLogInfoHelper.getRequestHeaderBean(), proceedingJoinPoint.getSignature().getDeclaringTypeName(), proceedingJoinPoint.getSignature().getName(), proceedingJoinPoint.getSignature().getDeclaringTypeName(), methodCallDetails.getExecution_Time());
        } catch (Exception e) {
            AppAlarm appAlarm = Log.getExceptionAlarm("OEB", "LE", EventAppLayers.WEB_SERVICE, EventAction.WRITE, e.getClass().getName());
            ResponseBean exceptionbean = new ResponseBean(appAlarm);
            exceptionbean.add("message", String.format(appAlarm.getMessage(), e.getMessage()));
            httpStatusCode = HttpStatus.valueOf(appAlarm.getAlarmStatus());
    ...
    public Object aroundAdvice2Update(ProceedingJoinPoint proceedingJoinPoint) throws Throwable {
        ...
        try {
            ...
            AppAlarm appAlarm = Log.getExceptionAlarm("OEB", "LE", EventAppLayers.WEB_SERVICE, EventAction.UPDATE, e.getClass().getName());
            ResponseBean exceptionbean = new ResponseBean(appAlarm);
            exceptionbean.add("message", String.format(appAlarm.getMessage(), e.getMessage()));
            httpStatusCode = HttpStatus.valueOf(appAlarm.getAlarmStatus());
            methodCallDetails = setMethodPostCallDetails(methodCallDetails, HealthConstants.METHOD_EXCEPTION, httpStatusCode.name());
    ...
    public Object aroundAdvice2Delete(ProceedingJoinPoint proceedingJoinPoint) throws Throwable {
        ...
        try {
            ...
            AppAlarm appAlarm = Log.getExceptionAlarm("OEB", "LE", EventAppLayers.WEB_SERVICE, EventAction.DELETE, e.getClass().getName());
            ResponseBean exceptionbean = new ResponseBean(appAlarm);
            exceptionbean.add("message", String.format(appAlarm.getMessage(), e.getMessage()));
            httpStatusCode = HttpStatus.valueOf(appAlarm.getAlarmStatus());
            methodCallDetails = setMethodPostCallDetails(methodCallDetails, HealthConstants.METHOD_EXCEPTION, httpStatusCode.name());
    ...
    public Object aroundAdvicefindOperation(ProceedingJoinPoint proceedingJoinPoint) throws Throwable {
        ...
        try {
            ...
            AppAlarm appAlarm = Log.getExceptionAlarm("OEB", "LE", EventAppLayers.WEB_SERVICE, EventAction.READ, e.getClass().getName());
            ResponseBean exceptionbean = new ResponseBean(appAlarm);
            exceptionbean.add("message", String.format(appAlarm.getMessage(), e.getMessage()));
            httpStatusCode = HttpStatus.valueOf(appAlarm.getAlarmStatus());
            methodCallDetails = setMethodPostCallDetails(methodCallDetails, HealthConstants.METHOD_EXCEPTION, httpStatusCode.name());
    ...
    public Object aroundAdvice2AllOther(ProceedingJoinPoint proceedingJoinPoint) throws Throwable {
        ...
        try {
            ...
            AppAlarm appAlarm = Log.getExceptionAlarm("OEB", "LE", EventAppLayers.WEB_SERVICE, EventAction.READ_WRITE_UPDATE, e.getClass().getName());
            ResponseBean exceptionbean = new ResponseBean(appAlarm);
            exceptionbean.add("message", String.format(appAlarm.getMessage(), e.getMessage()));
            httpStatusCode = HttpStatus.valueOf(appAlarm.getAlarmStatus());
            methodCallDetails = setMethodPostCallDetails(methodCallDetails, HealthConstants.METHOD_EXCEPTION, httpStatusCode.name());
    ...
    @Pointcut("execution(* com.app.server.service.organizationextendedbc.locationextended..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* com.app.server.service.organizationextendedbc.locationextended..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* com.app.server.service.organizationextendedbc.locationextended..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* com.app.server.service.organizationextendedbc.locationextended..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* com.app.server.service.organizationextendedbc.locationextended..get*(..)) && !within(com.spartan.server.session.bizService.SessionDataMgtService+)")
    protected void getOperation() {
    }

    @Pointcut("execution(* com.app.server.service.organizationextendedbc.locationextended..*(..)) && !within(com.spartan.server.session.bizService.SessionDataMgtService+)")
    protected void allOperation() {
    }

    @Pointcut("execution(* com.app.server.service.organizationextendedbc.locationextended..*(..)) && !within(com.spartan.server.session.bizService.SessionDataMgtService+) && ! findOperation() && ! saveOperation() && ! updateOperation() && ! deleteOperation()")
