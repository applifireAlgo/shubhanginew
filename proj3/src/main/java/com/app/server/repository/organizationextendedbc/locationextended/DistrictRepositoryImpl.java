...
@Repository
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "john.doe", versionNumber = "2", comments = "Repository for District Master table Entity", complexity = Complexity.LOW)
public class DistrictRepositoryImpl extends SearchInterfaceImpl implements DistrictRepository<District> {
    ...
    public List<District> findAll() throws Exception {
        ...
        java.util.List<com.app.shared.organizationextendedbc.locationextended.District> query = emanager.createQuery("select u from District u where u.systemInfo.activeStatus=1").getResultList();
    ...
    public List<District> save(List<District> entity) throws Exception {
        ...
        for (int i = 0; i < entity.size(); i++) {
            com.app.shared.organizationextendedbc.locationextended.District obj = entity.get(i);
    ...
    public void delete(String id) throws Exception {
        javax.persistence.EntityManager emanager = emfResource.getResource();
        com.app.shared.organizationextendedbc.locationextended.District s = emanager.find(com.app.shared.organizationextendedbc.locationextended.District.class, id);
        emanager.remove(s);
    ...
    public District findById(String districtId) throws Exception {
        ...
        com.app.shared.organizationextendedbc.locationextended.District listOfDistrict = (com.app.shared.organizationextendedbc.locationextended.District) query.getSingleResult();
