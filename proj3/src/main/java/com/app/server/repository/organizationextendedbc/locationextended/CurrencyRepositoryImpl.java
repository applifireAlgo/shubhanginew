...
@Repository
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "john.doe", versionNumber = "2", comments = "Repository for Currency Master table Entity", complexity = Complexity.LOW)
public class CurrencyRepositoryImpl extends SearchInterfaceImpl implements CurrencyRepository<Currency> {
    ...
    public List<Currency> findAll() throws Exception {
        ...
        java.util.List<com.app.shared.organizationextendedbc.locationextended.Currency> query = emanager.createQuery("select u from Currency u where u.systemInfo.activeStatus=1").getResultList();
    ...
    public List<Currency> save(List<Currency> entity) throws Exception {
        ...
        for (int i = 0; i < entity.size(); i++) {
            com.app.shared.organizationextendedbc.locationextended.Currency obj = entity.get(i);
    ...
    public void delete(String id) throws Exception {
        javax.persistence.EntityManager emanager = emfResource.getResource();
        com.app.shared.organizationextendedbc.locationextended.Currency s = emanager.find(com.app.shared.organizationextendedbc.locationextended.Currency.class, id);
        emanager.remove(s);
    ...
    public Currency findById(String currencyId) throws Exception {
        ...
        com.app.shared.organizationextendedbc.locationextended.Currency listOfCurrency = (com.app.shared.organizationextendedbc.locationextended.Currency) query.getSingleResult();
