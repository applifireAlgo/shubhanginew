...
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "john.doe", versionNumber = "2", comments = "Currency", complexity = Complexity.LOW)
...
public class Currency implements Serializable, CommonEntityInterface, Comparator<Currency> {
    ...
    public boolean equals(Object obj) {
        try {
            com.app.shared.organizationextendedbc.locationextended.Currency other = (com.app.shared.organizationextendedbc.locationextended.Currency) obj;
            if (currencyId == null) {
                return false;
