...
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "john.doe", versionNumber = "2", comments = "District", complexity = Complexity.LOW)
...
public class District implements Serializable, CommonEntityInterface, Comparator<District> {
    ...
    public boolean equals(Object obj) {
        try {
            com.app.shared.organizationextendedbc.locationextended.District other = (com.app.shared.organizationextendedbc.locationextended.District) obj;
            if (districtId == null) {
                return false;
