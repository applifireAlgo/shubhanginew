...
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "john.doe", versionNumber = "2", comments = "Village", complexity = Complexity.LOW)
...
public class Village implements Serializable, CommonEntityInterface, Comparator<Village> {
    ...
    public boolean equals(Object obj) {
        try {
            com.app.shared.organizationextendedbc.locationextended.Village other = (com.app.shared.organizationextendedbc.locationextended.Village) obj;
            if (villageId == null) {
                return false;
