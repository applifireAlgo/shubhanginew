Ext.define("Proj3.view.clouddrive.CloudDrive", {
	extend : 'Ext.panel.Panel',
	xtype : 'clouddrive',
	requires : [ 'Proj3.view.clouddrive.CloudDriveController',
	             'Proj3.view.clouddrive.documentview.DocumentsView',
	             'Proj3.view.clouddrive.drivedetails.DriveDetails',
	             //'Proj3.view.clouddrive.documentview.DocumentListView'
	             ],
