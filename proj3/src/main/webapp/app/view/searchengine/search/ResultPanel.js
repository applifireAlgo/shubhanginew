Ext
		.define(
				'Proj3.view.searchengine.search.ResultPanel',
				{
					extend : 'Ext.panel.Panel',
					xtype : 'resultPanel',
					itemId : "resultsTab",
					plugins : 'responsive',
					requires : [ 'Proj3.view.searchengine.search.SearchEngineMainPanelController','Proj3.view.searchengine.search.PanelHeaderField' ,'Proj3.view.searchengine.search.ReportGridView','Proj3.view.searchengine.search.ReportChartView','Proj3.view.searchengine.search.documentView','Proj3.view.searchengine.search.DouMeanView','Proj3.view.googlemaps.map.MapPanel'],
