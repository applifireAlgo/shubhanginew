Ext.define('Proj3.view.searchengine.search.SearchEngineMainPanel', {
	extend : 'Ext.panel.Panel',
	xtype : 'solrsearchmainpanel',
	

	requires : ['Proj3.view.searchengine.search.NorthPanel', 'Proj3.view.searchengine.search.SearchResult','Proj3.view.searchengine.search.SearchEngineMainPanelController'],
