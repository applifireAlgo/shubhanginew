Ext.define('Proj3.view.desktop.design.drawer.main.MainPanelController', {
    ...
    onMyProfileClick : function()
    {
         ...
         this.pushViewInMainTab( "Proj3.view.usermanagement.enduser.UserProfile","My Profile","menuAction","Proj3.view.usermanagement.enduser.UserProfile");
    },
    
    onChangePwdClick:function()
    {
      
         this.pushViewInMainTab( "Proj3.view.usermanagement.enduser.ChangePwd","Change Password","menuAction","Proj3.view.usermanagement.enduser.ChangePwd");
    },
     onCloudClick : function()
    {
        
        this.pushViewInMainTab("Proj3.view.clouddrive.CloudDrive","Cloud Drive","menuAction","Proj3.view.clouddrive.CloudDrive");
    },
