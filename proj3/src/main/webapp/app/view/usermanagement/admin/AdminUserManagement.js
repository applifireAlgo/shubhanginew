Ext.define('Proj3.view.usermanagement.admin.AdminUserManagement', {
	extend : 'Ext.tab.Panel',
	requires : ['Proj3.view.usermanagement.admin.UserPasswordReset',
	            'Proj3.view.usermanagement.admin.AddUserDetails',
	            'Proj3.view.usermanagement.admin.ViewUser'],
