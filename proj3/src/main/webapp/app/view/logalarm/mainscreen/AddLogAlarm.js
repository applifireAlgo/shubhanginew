 ...
 * 
 */
Ext.define('Proj3.view.logalarm.mainscreen.AddLogAlarm', {
	extend : 'Ext.form.Panel',
	xtype : 'addLogAlarm',
	requires : [ 'Proj3.view.logalarm.mainscreen.AddLogAlarmController',
			'Proj3.view.logalarm.mainscreen.AppAlarmGridPanel',
			'Proj3.view.logalarm.mainscreen.AppAlarmPanel',
