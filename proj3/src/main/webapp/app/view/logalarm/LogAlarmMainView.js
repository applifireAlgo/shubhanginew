 ...
 * 
 */
Ext.define('Proj3.view.logalarm.LogAlarmMainView', {
	extend : 'Ext.form.Panel',
	xtype : 'logAlarmMainView',
	requires : [ 'Proj3.view.logalarm.LogAlarmMainViewController',
			'Proj3.view.logalarm.tree.LogAlarmTreePanel',
			'Proj3.view.logalarm.mainscreen.LogAlarmMainViewTabPanel',
