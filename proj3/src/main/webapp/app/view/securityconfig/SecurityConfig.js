 ...
 * 
 */
Ext.define('Proj3.view.securityconfig.SecurityConfig', {
	extend : 'Ext.form.Panel',
	xtype : 'securityConfig',
	requires : [ 'Proj3.view.securityconfig.SecurityConfigController',
			'Proj3.view.securityconfig.SecurityQuestion', 'Ext.form.FieldSet',
