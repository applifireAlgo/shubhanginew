 ...
 * 
 */
Ext.define('Proj3.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab', {
	...
	requires : ['Proj3.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTabController'],
