...
Ext
		.define(
				'Proj3.view.logger.LogConfigurationTabPanel',
				{
					...
					requires : [
							'Proj3.view.logger.tabs.details.DetailsTab',
							'Proj3.view.logger.tabs.fileconnector.FileConnectorTab',
							'Proj3.view.logger.tabs.dbconnector.DBConnectorTab',
							'Proj3.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab',
							'Proj3.view.logger.tabs.tcpsocketconnector.TCPSocketConnectorTab',
							'Proj3.view.logger.LogConfigurationTabPanelController',
