Ext.define('Proj3.proj3.web.com.controller.organizationextendedbc.locationextended.TalukaMainController', {
     ...
     refreshMainForm: function(but, data, method) {
          var formPanel = this.view.down('#TalukaForm');
     ...
     hideDataBrowser: function() {
          var form = this.view.down('#TalukaForm');
          var grid = this.view.down('#TalukaGrid');
     ...
     treeClick: function(me, record, item, index, e, eOpts) {
          if (record.data.leaf) {
               ...
               var formPanel = this.getView().up().down('#TalukaForm');
               jsonData = {
                    'findKey': primaryKey
               }
     ...
     renderFormValue: function(val, me) {
          store = this.view.up().down('#TalukaForm').down('#' + me.column.dataIndex + '').store;
