Ext.define('Proj3.proj3.web.com.controller.organizationextendedbc.locationextended.CurrencyMainController', {
     extend: 'Proj3.view.fw.frameworkController.FrameworkViewController',
     ...
     refreshMainForm: function(but, data, method) {
          var formPanel = this.view.down('#CurrencyForm');
     ...
     hideDataBrowser: function() {
          var form = this.view.down('#CurrencyForm');
          var grid = this.view.down('#CurrencyGrid');
     ...
     treeClick: function(me, record, item, index, e, eOpts) {
          if (record.data.leaf) {
               ...
               var formPanel = this.getView().up().down('#CurrencyForm');
               jsonData = {
                    'findKey': primaryKey
               }
     ...
     renderFormValue: function(val, me) {
          store = this.view.up().down('#CurrencyForm').down('#' + me.column.dataIndex + '').store;
