Ext.define('Proj3.proj3.web.com.controller.organizationextendedbc.locationextended.DistrictMainController', {
     ...
     refreshMainForm: function(but, data, method) {
          var formPanel = this.view.down('#DistrictForm');
     ...
     hideDataBrowser: function() {
          var form = this.view.down('#DistrictForm');
          var grid = this.view.down('#DistrictGrid');
     ...
     treeClick: function(me, record, item, index, e, eOpts) {
          if (record.data.leaf) {
               ...
               var formPanel = this.getView().up().down('#DistrictForm');
               jsonData = {
                    'findKey': primaryKey
               }
     ...
     renderFormValue: function(val, me) {
          store = this.view.up().down('#DistrictForm').down('#' + me.column.dataIndex + '').store;
