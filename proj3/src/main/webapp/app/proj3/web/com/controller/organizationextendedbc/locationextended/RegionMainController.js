Ext.define('Proj3.proj3.web.com.controller.organizationextendedbc.locationextended.RegionMainController', {
     ...
     refreshMainForm: function(but, data, method) {
          var formPanel = this.view.down('#RegionForm');
     ...
     hideDataBrowser: function() {
          var form = this.view.down('#RegionForm');
          var grid = this.view.down('#RegionGrid');
     ...
     treeClick: function(me, record, item, index, e, eOpts) {
          if (record.data.leaf) {
               ...
               var formPanel = this.getView().up().down('#RegionForm');
               jsonData = {
                    'findKey': primaryKey
               }
     ...
     renderFormValue: function(val, me) {
          store = this.view.up().down('#RegionForm').down('#' + me.column.dataIndex + '').store;
