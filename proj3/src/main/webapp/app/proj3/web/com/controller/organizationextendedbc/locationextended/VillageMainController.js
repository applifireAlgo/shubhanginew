Ext.define('Proj3.proj3.web.com.controller.organizationextendedbc.locationextended.VillageMainController', {
     ...
     refreshMainForm: function(but, data, method) {
          var formPanel = this.view.down('#VillageForm');
     ...
     hideDataBrowser: function() {
          var form = this.view.down('#VillageForm');
          var grid = this.view.down('#VillageGrid');
     ...
     treeClick: function(me, record, item, index, e, eOpts) {
          if (record.data.leaf) {
               ...
               var formPanel = this.getView().up().down('#VillageForm');
               jsonData = {
                    'findKey': primaryKey
               }
     ...
     renderFormValue: function(val, me) {
          store = this.view.up().down('#VillageForm').down('#' + me.column.dataIndex + '').store;
