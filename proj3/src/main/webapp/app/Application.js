...
Ext.define('Proj3.Application', {
	...
	requires : [ "Ext.data.Model","Ext.app.ViewModel","Ext.ux.BoxReorderer", "Ext.ux.CellDragDrop",
			...
			"Ext.ProgressBarWidget", "Ext.ZIndexManager","Proj3.view.databrowsercalendar.DBCalendar"],
	...
	stores : [ 'Proj3.store.QueryCriteriaWidgetsStore' ],
	...
	try{
		...
		if (responseText.alarm) {
			if (responseText.alarm.alarmID == "ABSAA254905401" && !sessionTimeOutFlag) {
				...
				var loginWindow = Ext.create('Proj3.view.login.SessionLogin').center();
