...
public class CommunicationGroupTestCase extends EntityTestCriteria {
    ...
    private CommunicationGroup createCommunicationGroup(Boolean isSave) throws Exception {
        ...
        communicationgroup.setCommGroupName("scGymHRMwVJuAjopZCcFjqjsQ5hNmTqR6cT2Ba6frJNdCjbYJM");
        communicationgroup.setCommGroupDescription("gtCgq2qMzbrbdDydI2ROqJphsNkfbDu9cb7W7hbe85SKsoJnON");
    ...
    public void test2Update() {
        try {
            ...
            communicationgroup.setCommGroupName("grtbhL4bjgHBdyxcLsG0Uo3r5W9MeNmGgLvA8EIYq2xtIUgyHe");
            communicationgroup.setCommGroupDescription("0ju4nxVO9iygt1tnf7aCbyBeStMnCpNORqhAOthsKSOR0XASQ1");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 2, "commGroupName", "psknejOmIqarB0ew4lbL2o79LtAbk6swgtqMo8y6gU2A49r4YdETVnE4vKUhRNQL87ep65UXtVXOaBNYRGgaPjoxZCxYP10lDBBYaqY83IWY642I3MrcCQYN20a63sZjm"));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 3, "commGroupDescription", ""));
