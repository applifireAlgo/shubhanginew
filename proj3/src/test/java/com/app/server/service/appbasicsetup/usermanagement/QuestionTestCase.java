...
public class QuestionTestCase extends EntityTestCriteria {
    ...
    private Question createQuestion(Boolean isSave) throws Exception {
        ...
        question.setQuestionIcon("ptMu7toOikSsqrvRDOCRwtxwV5OWve9XN1ePZxeDB18bv59KRU");
        question.setQuestion("hV0IAJNMea0JH94URI8rAz1DGrI6YAqZEtthdkyAGTQZ3fcj5u");
        question.setLevelid(1);
        question.setQuestionDetails("UqBX0SMrDr");
    ...
    public void test2Update() {
        try {
            ...
            question.setQuestionIcon("HYYMy64ZQFRkH7KU2E1rztGQVSvNwViw8JXPDmYWMAEd7bRKWl");
            question.setQuestion("Nhmfm34045MOcNlRtPMe4MXWuVmag1JQETpPL7EvB9yV9IZhuP");
            question.setVersionId(1);
            question.setLevelid(10);
            question.setQuestionDetails("UDbNc0T7nI");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 4, "question", ""));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 5, "questionDetails", ""));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 6, "questionIcon", "TQZX4zH22ypKEkpKl33HDjDZYp8d0WbR7HGoXoanB3Nles3uskJHbGWMAO3vEeYW8"));
