...
public class TitleTestCase extends EntityTestCriteria {
    ...
    private Title createTitle(Boolean isSave) throws Exception {
        ...
        title.setTitles("Z6hpcy4X3DxHiHAlOvbeDnQipzZjortoU1cmuI8zkJvlzX41M0");
    ...
    public void test2Update() {
        try {
            ...
            title.setTitles("7As1ZJg3ZD7CMfPn5EguI53DUBjQzh1u9sdRcCQ3IwuEkS1ATe");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 2, "titles", ""));
