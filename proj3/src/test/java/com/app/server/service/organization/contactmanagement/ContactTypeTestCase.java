...
public class ContactTypeTestCase extends EntityTestCriteria {
    ...
    private ContactType createContactType(Boolean isSave) throws Exception {
        ...
        contacttype.setContactType("2ZyQycGB5NZFY3ZDOtTeTAgNB8ScfW1JUlTZaN9Ap8lSoXjalJ");
        contacttype.setContactTypeDesc("FXvF20HXokSsVNNXWmGD4frRTrHRBZsBOVTgmvBWyw5RaE16fI");
        contacttype.setContactTypeIcon("TyRTdze8C5PgqTY2k2vh7klW1BAuYnnoCe9ECUcACz16b2AtZJ");
    ...
    public void test2Update() {
        try {
            ...
            contacttype.setContactType("fiYdOkTMSkE6mlqbxcSz70omOl51zLWZZ6UgVnwdUCBOWvPHbz");
            contacttype.setVersionId(1);
            contacttype.setContactTypeDesc("ehYEwKS3yTRcgfoN5NuMp24kviTKvQ7i4mAjyYhRkPr7xHyKvM");
            contacttype.setContactTypeIcon("ND3B7LSvdT1UM3CRkArlFpH1N9ya1YhDA1uCiTuaWwkMUuqy8W");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 2, "contactType", "wLedUKeDxXhyKUrRf1Lovw2RJsWykLEQU06djvPpZyJEnIXEdym7fAJofuHnGetiMVneFRiBwxlxFBQv1bUySK3jKlx7Yv4gAsYyOb53973yoevExRDppp9oK4CCer8ZM"));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 3, "contactTypeDesc", ""));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 4, "contactTypeIcon", "0NxhmvI0XQvmImJ82RdzOpCq1QVsLgiBzL7aHBXE9cfHlVvci8m0DsglEdjQJA9nJlwWhSr4kzCzMVNa0g5lQFjRDnS9Xr87aehNCjOBdbD7ox85BuSZjn8rEvsQQoKND"));
