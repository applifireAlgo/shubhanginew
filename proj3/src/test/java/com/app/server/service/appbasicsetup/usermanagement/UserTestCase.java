...
public class UserTestCase extends EntityTestCriteria {
    ...
    private User createUser(Boolean isSave) throws Exception {
        ...
        useraccesslevel.setLevelName("neHqXCP4EPb7Ixt8HMzAJFsekZbOVOKXBPBLpJZ49Lpm2lOcys");
        useraccesslevel.setLevelHelp("3fyYi2oV9eG82dvxOZDGUp47BUFBRHwXowkP57JlTAuExyyczH");
        useraccesslevel.setLevelDescription("KrqX36lYOzuHF1Y3mf9uRaQQMxy8WlIPxZlxrk1ySReTGxNTZi");
        useraccesslevel.setLevelIcon("JT1d8XFF72KLYP0mwI88zSFjNJzlrfaQzMmf82mse9giCLCkdX");
        ...
        useraccessdomain.setDomainIcon("26QEYfKhUVEAbBDh2adYUc1CqxB3JlUdA89jkmj5rLzVWin9vk");
        useraccessdomain.setDomainHelp("AOPRKwYDUlA9DNEDU4UDOWCB3Mv04ClcZTxmNCho4eZ77uQeen");
        useraccessdomain.setDomainName("kVFtgHXXnkj6cJs6ShAH8Ew9rjhUvJSG9e6gRAKiI1f9IKJKm8");
        useraccessdomain.setDomainDescription("XsDEMHK45qqqpkQ8pQjOciSP4kDFB5nNeHLt7mZkNZdwJ53qWS");
        ...
        User user = new User();
        user.setSessionTimeout(3129);
        user.setUserAccessLevelId((java.lang.String) UserAccessLevelTest._getPrimarykey()); /* ******Adding refrenced table data */
        user.setIsLocked(1);
        user.setUserAccessCode(54157);
        user.setMultiFactorAuthEnabled(1);
        user.setPasswordExpiryDate(new java.sql.Timestamp(1465284051115l));
        user.setChangePasswordNextLogin(1);
        user.setGenTempOneTimePassword(1);
        user.setLastPasswordChangeDate(new java.sql.Timestamp(1465284051115l));
        user.setPasswordAlgo("nn9V0LHx5RoTUV3a2MwY8dWq1LcXTPqsulBUb5Ki9JSiet0jax");
        ...
        question.setQuestionIcon("NLNE8c0XGZ3S1rnrNkDBmD7C2jtLmu1Ruase8kvvw9Mld4xsr4");
        question.setQuestion("vAhxXAJrfuOuOEEQshuHraiB7pL41MrJLqhV3rk0jayhYXfxRz");
        question.setLevelid(4);
        question.setQuestionDetails("7iS7ES8Azu");
        ...
        passrecovery.setAnswer("PjqCYINTdYzGqCeb4xj8PDchYFGJX1qasF1ekCXPJ9LRcEqGIZ");
        listOfPassRecovery.add(passrecovery);
        user.addAllPassRecovery(listOfPassRecovery);
        UserData userdata = new UserData();
        userdata.setUser(user);
        userdata.setLast5Passwords("Kenby2qY2eVXZ0lBo1VT5eLsibPk0t3CaWQmq2j3WuH08h0tty");
        userdata.setOneTimePassword("g60mu9voMgbG5z0hvnYvtRG4om71ic36");
        userdata.setPassword("eHwNK6PCcA4pFvQRW2kQNvhQGazaz1ppy6fMYuOuSEfs1QPMYl");
        userdata.setOneTimePasswordExpiry(3);
        userdata.setOneTimePasswordGenDate(new java.sql.Timestamp(1465284051335l));
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 1, "userAccessCode", 84226));
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 8, "passwordAlgo", "8LcmZTEXwvVl3Gb4aPeZJrddGg21uZhfOiGXRiw5eWshyEUEo862xrgD8Zit5NmM1"));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 9, "sessionTimeout", 4321));
